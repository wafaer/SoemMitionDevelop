...
typedef struct {
    int32_t pos_cmd;                 /* commanded axis position */
    int32_t teleop_vel_cmd;          /* commanded axis velocity */
    int32_t max_pos_limit;           /* upper soft limit on axis pos */
    int32_t min_pos_limit;           /* lower soft limit on axis pos */
    int32_t vel_limit;               /* upper limit of axis speed */
    int32_t acc_limit;               /* upper limit of axis accel */
    ...
    int32_t ext_offset_vel_limit;    /* upper limit of axis speed for ext offset */
    int32_t ext_offset_acc_limit;    /* upper limit of axis accel for ext offset */
...
static axis_hal_data_t *axis_hal_data = NULL;
...
void axis_handle_jogwheels(bool motion_teleop_flag, bool motion_enable_flag, bool homing_is_active)
{
    ...
    int32_t distance, pos, stop_dist;
